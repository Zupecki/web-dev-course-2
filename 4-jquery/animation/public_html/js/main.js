window.onload = function () {
    //get all shape elements on page
    var shapes = createShapes($(".shape").toArray());

    //click .shape class
    $(".shape").click(function () {
        let shapeObject = getElementObject($(this), shapes);

        //animate shape to given coordinates
        shapeObject.moveTo(500, 500);
